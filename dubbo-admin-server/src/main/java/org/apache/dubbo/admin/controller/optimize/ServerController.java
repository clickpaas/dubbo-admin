...
public class ServerController {
    ...
    @RequestMapping(value = "/server/service/url", method = RequestMethod.POST)
    public UrlDTO searchUrl(@RequestBody UrlDetailRequest request, @PathVariable String env){
        return serverService.searchUrl(request);
    }
